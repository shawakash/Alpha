...
<nav className="flex flex-row justify-between items-center bg-slate-900 w-full py-3 px-10 pr-16 gap-x-52 border-b-[0.25px] border-slate-500 sticky top-0 bg-opacity-90">
...
<div className="titleBar">
    <ul className="flex w-fit px-1 py-[4px] justify-between text-sm items-center gap-x-6 text-slate-400 font-rob font-medium bg-slate-700 rounded-lg ">
