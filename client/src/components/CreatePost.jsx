...
function CreatePost() {
    return (
        <div className="bg-slate-900 text-slate-200 bg-transparent backdrop-blur-lg flex flex-col px-10 py-5 w-full rounded-lg border-slate-500 border-[0.25px] gap-y-8">
            <div className="up flex w-full gap-x-5">
                ...
                <input type="text" className=" bg-transparent border-slate-300 border px-8 py-1 rounded-full w-full  text-slate-300 text-base outline-none" placeholder="What's on your Mind" />
            </div>
